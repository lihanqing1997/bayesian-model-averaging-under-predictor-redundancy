...
Table~\ref{tab:logisticcheck} repeats the compression calculation for a binary logistic support posterior. It is a small algebra check, not a full GLM BMA benchmark.
...
\caption{Prediction-only baselines in the exact benchmark.}
...
\caption{Prediction-only baselines in the large \(p=100\) benchmark.}
...
\caption{\(q_0\)-screened large \(p=100\) frontier.}
